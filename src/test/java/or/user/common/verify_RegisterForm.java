...
public class verify_RegisterForm {
	...
	public verify_RegisterForm load_App_URL() {
	...
	public void performLogin(String usertype) {
		...
		for (int i = 0; i < rows; i++) {
			...
			if (deta.equals(usertype)) {
				...
				Reporter.NODE("Verfiying update profile Ui page");

				com.isElementPresent(input_Name, "verify first name");
				com.isElementPresent(input_Email, "verify email");
				com.isElementPresent(input_Phone, "verify Phone");
				com.isElementPresent(input_Address, "verify email");
				com.isElementPresent(input_City, "verify contact");
				com.isElementPresent(input_postalcode, "verify country");
				com.isElementPresent(country_Dropdown, "verify address");
				com.isElementPresent(button_Submit, "verify update profile button");
				com.isElementPresent(button_Cancel, "verify cancel button");
