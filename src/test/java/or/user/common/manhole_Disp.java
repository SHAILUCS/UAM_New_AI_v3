...
public class manhole_Disp {
	...
	public manhole_Disp load_App_URL() {
	...
	public void funct_ManDispaly(String usertype, WebElement we) {
		...
		for (int i = 0; i < rows; i++) {
			...
			if (deta.equals(usertype)) {
				...
				com.wait(4);
				com.click(button_Close, " close button");
