...
public class ExcelManager {
	...
	private void initSheetObject(String sheetName) {
		try{
			...
			if(sheet == null) {
				System.out.println("Sheet Name ["+sheetName+"] does not exist in file ["+workbookPath+"]");
				//Reporter.report(STATUS.ERROR, "Sheet Name ["+sheetName+"] does not exist in file ["+workbookPath+"]");
			}
		}catch(Exception e){
			new Custom_ExceptionHandler(e);
		}
